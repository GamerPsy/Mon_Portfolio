            ...
            <div class="card card-body fond-sport">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-4 pb-2">
                        <div class="card fond-card-netflix h-100">
                            <div class="card-header">
                                <h4 class="text-center text-warning">Pith'Race 2018</h4>
                            </div>
                            <div class="card-body next-incoming">
                                <h3>Pith'Race 2018</h3>
                            </div>
                            <div class="card-footer">
                    ...
                    <div class="col-12 col-sm-4 pb-2">
                        <div class="card fond-card-netflix h-100">
                            <div class="card-header">
                                <h4 class="text-center text-warning">Futur objectif</h4>
                            </div>
                            <div class="card-body next-incoming">
                                <p class="incoming">Prochaine course d'obstacles!</p>
                            </div>
                            <div class="card-footer">
                                <i class="fas fa-clock mr-2"></i> à voir
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-sm-6 pb-2">
                        <div class="card bg-primary h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    Parti sur le chemin depuis Bordeaux, 1200km à pieds pour arriver au bout du monde.
                                    Une merveilleuse aventure humaine avec de jolies rencontres.
                                </p>
                            </div>
                            <div class="card-footer">
                                <i class="fas fa-clock mr-2"></i> été 2019
                    ...
                    <div class="col-12 col-sm-6 pb-2">
                        <div class="card bg-primary h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    J'ai adhéré à l'association depuis que j'ai pris la décision d'aller sur le chemin.
                                </p>
                            </div>
                            <div class="card-footer">
                                <i class="fas fa-clock mr-2"></i> adhérent depuis 5 mois
                            </div>
                        </div>
                    </div>
                    <!----------------- Santiago 2019 ------------------------>
