    ...
    <div class="container mt-auto">
        <div class="row">
                ...
                <div class="card w-100 h-100">
                    ...
                    <div class="card-body">
                        <ul>
                            ...
                            <li hidden><span class="font-weight-bold">Age :</span> <?= $ageOfRemy ?> ans</li>
                            ...
                            <br />
                            <li class="font-weight-bold">Le contacter :
                                <ul>
                                    <li><a href="contact.php"> Formulaire de contact </a></li>
                                    <li><a href="mailto:contact@remy-ducry.fr"> e-mail </a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="col-12 col-sm-4">
                <div class="thumbnail">
                    <img class="effect rounded mx-auto d-block img-fluid img-thumbnail w-100 h-100" src="images/moi.png" alt="Rémy himself !">
                </div>
            </div>
        </div>
        <div class="row pt-3">
            ...
            <div class="card col-12 justify-content-center">
                <div class="card-body mx-auto">
                    ...
                    <br />
                    Je suis <span class="font-weight-bold">analytique</span>, <span class="font-weight-bold">rigoureux</span>,
                    les philosophies <span class="font-weight-bold">DRY</span> et <span class="font-weight-bold">KISS</span> 
                    sont mes amies naturelles et le métier du test me colle à merveille.
                    <br />
                    ...
                    <div class="card-footer mx-auto pt-4">
                        <button class="btn btn-dark mx-auto d-block" type="button" data-toggle="collapse" data-target="#versiondetail" aria-expanded="false" aria-controls="versiondetail">
                    ...
                    <div class="collapse" id="versiondetail">
                        <div class="card card-body">
                            ...
                            <br />
                            Plus jeune je voulais devenir programmeur de jeux vidéo puis mon parcours de vie et mon fort
                            attachement à certaines valeurs humaines m’ont fait choisir une carrière dans le soin à la personne.
                            J’ai évolué au fil du temps et des expériences de vie pour me concentrer de plus en plus sur mon 
                            évolution personnelle, c’est dans ce contexte qu'en 2018 j’ai ressenti le besoin de revenir à ma 
                            passion et mon rêve d’enfant/adolescent.
                            <br />
                            ...
                            <br />
                            J'ai fait le choix d'une formation intensive à la Wild Code School pour son approche pédagogique
                            innovante, j'y ai appris les bases de la programmation avec PHP et l'usage d'un framework PHP 
                            (Symfony 4).
                            <br />
                            ...
                            Mon profil correspond à celui d'un automaticien du fait que je suis développeur et testeur certifié ISTQB. 
                            <br/>
                            J'ai aussi des compétences appréciées et transposables dans le métier du test dont une solide 
                            capacité à travailler en équipe.
                            <br />
                            J'aime comprendre "comment ça fonctionne", pas mal de domaines sont pour moi des contrèes
                            inexplorées à explorer ! (Cyber Sécurité, objets connectés, Big Data, IA).
                            <br />
