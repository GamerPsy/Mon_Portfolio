...
<main class="bg-dark">
    <div class="container">
        ...
        <div class="row bg-warning">
            ...
            <div class="col-10">
                Standardiste - Office notarial Aimedieu-Destré, Marseille
            </div>
        </div>
        <!-- ============================ 2013-2014 =========================================================== -->
        <div class="row bg-warning mb-2">
            ...
            <div class="col-10">
                Aide-soignant - Agence d'intérim Eureka, Marseille
            </div>
        </div>
        <!-- ========================= 2013 ==================================================================== -->
        <div class="row bg-info mb-2">
        ...
        <div class="row bg-warning">
            ...
            <div class="col-10">
                Aide-Soignant - Clinique des 3 Cyprès, La Penne-sur-Huveaune
            </div>
        </div>
    </div>
</main>
