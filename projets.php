        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-4 pb-2">
                <div class="card bg-success h-100">
                    ...
                    <div class="card-body">
                        <p class="card-text">
                            Projet pour m'initier à la programmation de jeu vidéo, une idée assez simple mais qui
                            me permettra de toucher à des concepts de collisions, scores et peut-être même une IA pour
                            les ennemis.
                        </p>
                        <p class="card-skills">
            ...
            <div class="col-12 col-sm-6 pb-2">
                <div class="card bg-success h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Conception et réalisation de mon portfolio en ligne. Me permet de revoir mes bases et
            ...
            <div class="col-12 col-sm-6 pb-2">
                <div class="card color-wcs h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Conception et réalisation d'une application métier à l'usage des gestionnaires de biens
            ...
            <div class="col-12 col-sm-6 pb-2">
                <div class="card color-wcs h-100">
                    ...
                    <div class="card-footer">
                        ...
                        <span class="mx-2">|</span>
                        <i class="fas fa-clock mr-2"></i> 5 semaines
                        <span class="mx-2">|</span>
                        <i class="fas fa-user mr-2"></i> 5 personnes
                    </div>
                </div>
