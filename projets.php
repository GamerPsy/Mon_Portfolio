...
<main class="bg-dark">
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <h3 class="border-bottom text-center pb2">2019</h3>
            </div>
            ...
            <div class="col-6 pb-2">
                <div class="card bg-success">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Conception et réalisation de mon portfolio en ligne.
                        </p>
                        <p class="card-skills">
                    ...
                    <div class="card-footer">
                        ...
                        <i class="fas fa-user mr-2"></i> 1 personne ( moi-même ! )
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <h3 class="border-bottom text-center pb2">2018</h3>
            </div>
